...
_w['_sydConvTranslation'] = {
  ...
  welcomeMessageItemTitle1: '生日快乐老W',
  welcomeMessageItemTitle2: '祝你生日快乐',
  welcomeMessageItemTitle3: '天天开心哈',
  discoverMessageItemTitle: '生日快乐！！awa',
  welcomeMobCopilotSugg1: '生日快乐，老W！！！————张涵哲',
  welcomeMobCopilotSugg2: '生日快乐!!!————王翔好（来源CKIM）',
  welcomeMobCopilotSugg3: '祝你以后每一天都一样快乐!————王翔好（来源CKIM）',
  welcomeContainerFaq: '常见问题解答',
  welcomeMessageItemContent1: '生日快乐呀！————银墨 （来源C站）',
  welcomeMessageItemContent2: '老w生日快乐————才吃饭（来源C站）',
  welcomeMessageItemContent3: '生日快乐^~^ ————张铭轩（来源C站）',
  ...
  newTopicGreet1: '生日快乐！🎂🎉 祝你今天过得愉快，心想事成，幸福满满！🎈🎁🥳  ————Sydney',
  newTopicGreet2: '生日快乐⊙▽⊙————苏瑶瑶（来源C站）',
  newTopicGreet3: '生日快乐呀！————王韵涵（来源C站）',
  newTopicGreet4: '生日快乐————林业珵（来源C站）',
  newTopicGreet5: '老W生日快乐————陈致（来源CKIM）',
  newTopicGreet6: '祝泥生日快乐————史承延（来源C站）',
  newTopicGreet7: '老w声日块乐！————第五人格启动（来源C站）',
  newTopicGreet8: '生日快乐！🤗————雷贵焱（来源C站）',
  newTopicGreet9: '生日快乐！————诗诗（来源C站）',
  newTopicGreet10: '生日快乐！————王美钰（来源C站）',
  newTopicGreet11: '老w生快————斯亦轩（来源C站）',
  newTopicGreet12: '老W生日快乐————海阳工作室（来源C站）',
  newTopicSugg1: '生日快乐',
  newTopicSugg2: '天天开心，别emo了',
  newTopicSugg3: '在新的一岁里加油',
  newTopicSugg4: '加油，又长大了一岁',
  newTopicSugg5: '给自己许一个愿望吧',
  newTopicSugg6: '嘿嘿，生日快乐',
  newTopicSugg7: '祝你有个好成绩',
  newTopicSugg8: '心想事成',
  newTopicSugg9: '(ง •_•)ง',
  newTopicSugg10: '生日开心吗',
  newTopicSugg11: '要不要听笑话？',
  newTopicSugg12: '加油',
